...
System::System() : elapsedtime_(0), frametime_(0), entitycount_(0) {

}

System::System(ECSManager* ecsmanager) : ecsmanager_(ecsmanager), elapsedtime_(0), frametime_(0), entitycount_(0){
